 ...
 */
Led.prototype.on = function () {
  this.board.rfDigitalWrite(this.receiver, this.pin, this.board.HIGH);
  this.bright = 255;
}
 ...
 */
Led.prototype.off = function () {
  this.board.rfDigitalWrite(this.receiver, this.pin, this.board.LOW);
  this.bright = 0;
}

Led.prototype.brightLevel = function(val) {
  this.board.rfAnalogWrite(this.receiver, this.pin, this.bright = val);
}
